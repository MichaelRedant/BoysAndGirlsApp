...
<div class="breadcrumbs">
    <div class="breadcrumbs-container container">
        ...
        <a href="{{route('BoysJunior')}}">Boys Junior </a>
        <i class="fas fa-chevron-right breadcrumb-seperator"></i><span> Zoekresultaten </span>
        </div>
        <div>
          <form class="search-form" action="{{route('searchBoysJunior')}}"method="GET" ">
    ...
    <div class="container d-flex justify-content-center">
      <div class="row">
          <div class="col-sm-12">
              ...
              <img src="{{asset('img/Junior/Boys/'.$product->slug.'.jpg')}}" class="card-img-top" alt="Foto product Boys and Girls">
              <div class="card-body">
