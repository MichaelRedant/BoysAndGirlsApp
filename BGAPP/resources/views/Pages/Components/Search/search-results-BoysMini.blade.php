...
<div class="breadcrumbs">
    <div class="breadcrumbs-container container">
        ...
        <a href="{{route('BoysMini')}}">Boys Mini </a>
        <i class="fas fa-chevron-right breadcrumb-seperator"></i><span> Zoekresultaten </span>
        </div>
        <div>
          <form class="search-form" action="{{route('searchBoysMini')}}"method="GET" ">
...
<div class="search-container container list-group">
    ...
    @foreach ($products as $product)
        ...
        <img src="{{asset('img/Mini/Boys/'.$product->slug.'.jpg')}}" alt="Foto product Boys and Girls">
      </div>
    @endforeach
