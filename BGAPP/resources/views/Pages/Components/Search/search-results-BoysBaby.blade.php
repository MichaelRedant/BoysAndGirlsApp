...
<div class="breadcrumbs">
    <div class="breadcrumbs-container container">
        ...
        <div>
          <form class="search-form" action="{{route('searchBoysBaby')}}"method="GET" ">
    ...
    <div class="container d-flex justify-content-center">
      <div class="row">
          <div class="col-sm-12">
              ...
              <img src="{{aasset('img/Products/'.$product->slug.'.jpg')}}" class="card-img-top" alt="Foto product Boys and Girls">
              <div class="card-body">
